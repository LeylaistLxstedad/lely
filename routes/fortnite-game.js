...
app.get('/content/api/pages/fortnite-game', async (req, res) => {
    ...
    data.data.battleroyalenewsv2 = {
        news: {
            motds: [{
                ...
                spotlight: false,
                websiteURL: 'https://discord.io/zrxfn',
                websiteButtonText: 'Join our Discord Server'
            }]
        },
    ...
    data.data.dynamicbackgrounds = {
        ...
        backgrounds: {
            backgrounds: [
                {
                   backgroundimage: 'https://wallpapercave.com/wp/wp2601221.jpg',
                    stage: 'season18',
